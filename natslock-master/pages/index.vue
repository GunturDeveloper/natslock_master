  ...
  <div v-if="!token"
    ...
    <div class="flex flex-col justify-center h-full w-full p-10">
      <div class="flex flex-col">
        <h1 class="text-4xl font-bold text-blue-400">Locker Connectivity and</h1>
        <h1 class="text-4xl font-bold text-blue-50">Inovation for You</h1>
      </div>
      <div class="flex">
